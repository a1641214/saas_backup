...
RSpec.describe ClashRequestsController, type: :controller do
    ...
    describe 'GET #edit' do
        ...
        it 'map days of week to hash' do
            ...
            get :edit, id: clash_one.id

            expect(assigns(:map_session_by_day)).to include('monday', 'tuesday', 'wednesday', 'thursday', 'friday')
        end
    end
    ...
    describe 'POST #create' do
        it 'will create a new clash request' do
            c1 = FactoryGirl.create(:course, name: 'Engineering Software as Services I', catalogue_number: 'COMP SCI 3003')
            c2 = FactoryGirl.create(:course, name: 'Engineering Software as Services II', catalogue_number: 'COMP SCI 3004')
            c4 = FactoryGirl.create(:course, name: 'Soils and Landscapes I', catalogue_number: 'SOIL&WAT 1000WT')
            ...
            hash = {"student"=>"1705", "degree"=>"Bachelor of Arts", "semester"=>"Semester 1, 2017", "subject"=>"COMP SCI", "course"=>"1", "Lecture"=>"1", "Tutorial"=>"3"}
            student_one = FactoryGirl.create(:student, id: 1705)
            expect { post :create, :clash_resolution => hash }.to change(ClashRequest, :count).by(1)
        end
    end
end
